use super::Collector;
use collector::custom_score_top_collector::CustomScoreTopCollector;
...
use collector::tweak_score_top_collector::{
    ScoreSegmentTweaker, ScoreTweaker, TweakedScoreTopCollector,
};
use collector::{CustomScorer, CustomSegmentScorer, SegmentCollector};
